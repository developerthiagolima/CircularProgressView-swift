...
//  
//
//  Created by Thiago Lima on 23/03/18.
//  Copyright © 2018. All rights reserved.
//

import UIKit

class VADefaultColor {
    static let circleStrokeColor: UIColor = UIColor(red: 233.0/255.0, green: 233.0/255.0, blue: 233.0/255.0, alpha: 1)
    static let circleFillColor: UIColor =  UIColor(red: 105.0/255.0, green: 27.0/255.0, blue: 153.0/255.0, alpha: 0.2)//UIColor.white
    static let progressCircleStrokeColor: UIColor = UIColor(red: 105.0/255.0, green: 27.0/255.0, blue: 153.0/255.0, alpha: 1)
    static let progressCircleFillColor: UIColor = UIColor.clear //UIColor(red: 105.0/255.0, green: 27.0/255.0, blue: 153.0/255.0, alpha: 0.2)
}
...
class VACircularProgressView: UIView {
    ...
    private var circleStrokeWidth: CGFloat = 10
    private var circleStrokeColor: UIColor = VADefaultColor.circleStrokeColor
    private var circleFillColor: UIColor = VADefaultColor.circleFillColor
    private var progressCircleStrokeColor: UIColor = VADefaultColor.progressCircleStrokeColor
    private var progressCircleFillColor: UIColor = VADefaultColor.progressCircleFillColor
    ...
    func setCircleStrokeColor(_ circleStrokeColor: UIColor = VADefaultColor.circleStrokeColor, circleFillColor: UIColor = VADefaultColor.circleFillColor, progressCircleStrokeColor: UIColor = VADefaultColor.progressCircleStrokeColor, progressCircleFillColor: UIColor = VADefaultColor.progressCircleFillColor) {
